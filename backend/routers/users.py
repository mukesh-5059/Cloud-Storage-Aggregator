...
async def delete_my_account(
    ...
    user_access_token = await get_fresh_google_access_token(current_user, db)
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        for membership in user_memberships:
            ...
            for file_item in hosted_files:
                ...
                if target_host:
                    ...
                    target_access_token = await get_fresh_google_access_token(target_user, db) if target_user else None
                    ...
                    if user_access_token and target_access_token and target_user and file_item.gdrive_file_id:
                        try:
                            ...
                            dl_res = await client.get(download_url, headers={"Authorization": f"Bearer {user_access_token}"})
                            ...
                            if dl_res.status_code == 200:
                                ...
                                if up_res.status_code == 200:
                                    ...
                                    await client.delete(del_url, headers={"Authorization": f"Bearer {user_access_token}"})
            ...
            if user_access_token and membership.gdrive_folder_id:
                try:
                    ...
                    await client.delete(folder_del_url, headers={"Authorization": f"Bearer {user_access_token}"})
        ...
        if token_to_revoke:
            try:
                ...
                await client.post(revoke_url, headers={"Content-Type": "application/x-www-form-urlencoded"})
